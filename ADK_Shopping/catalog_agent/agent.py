...
catalog_agent = LlmAgent(
    ...
    Workflow:
    - Inform the user that you have 3 category of products as mentioned above and ask
    which category they would like to browse
    ...
    - If yes, get the quantity they want to add store the category, product and quantity
    into the state using save_cart() tool.
    - Once you have captured these details, check if the user
    wants to checkout and then handover to the checkout_agent
